...
- (void)viewDidLoad
{
    ...
    NSString *query = @"select Project from ProjectInfo";
...
- (IBAction)saveInfo:(id)sender {
    ...
    NSString *query = [NSString stringWithFormat:@"insert into TaskInfo values(null, '%@', '%@', '%@')", self.taskName.text, self.projectName.text, self.dueDate.text];
//    if (self.recordIDToEdit == -1) {
